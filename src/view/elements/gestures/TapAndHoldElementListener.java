...
public class TapAndHoldElementListener implements IGestureEventListener {
     ...
     */
    public TapAndHoldElementListener(MTApplication app, MTComponent parent) {
            super();
            this.app = app;
            this.parent = parent;
            ...
            e.setStrokeColor(new MTColor(255,255,255,255));
            e.setStrokeWeight(4);
            e.setNoFill(true);
            ...
            e.setController(new IMTController() {
                    public void update(long timeDelta) {
                            ...
                            if (parent != null){
                                    ...
                                    {
                                    	TapAndHoldElementListener.this.app.invokeLater(new Runnable() {
                                                    public void run(){
                                                            MTComponent parent = e.getParent();
                                                            if (parent != null){
